            ...
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
              ...
              >
                {product.map((item, index) => {
                  return <option key={index} value={item.category}>{item.category}</option>; // Added key prop
                })}
              </select>
              <select
                value={filterPrice}
              ...
              >
                {product.map((item, index) => {
                  return <option key={index} value={item.price}>{item.price}</option>; // Added key prop
                })}
              </select>
            </div>
          </div>
